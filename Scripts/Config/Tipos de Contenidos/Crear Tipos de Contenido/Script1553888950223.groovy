...
WebUI.setText(findTestObject('Config/Tipo contenido/inputNombre TipoCrearEditar'), 'Prueba de crear...')

WebUI.delay(3)

WebUI.executeJavaScript('$(\'body > app-root > div > mat-sidenav-container > mat-sidenav-content > div > div > app-content-type-create-form > div > div > form > mat-card > div > div > button.mat-raised-button.mat-primary\').trigger(\'click\');', 
    [])
