...
WebUI.executeJavaScript('$(\'body > app-root > div > mat-sidenav-container > mat-sidenav-content > div > div > app-topic-types-list > div > app-floating-actions-buttons > eco-fab-speed-dial > div > eco-fab-speed-dial-trigger > button > span\').trigger(\'click\')',
	[])

WebUI.delay(3)

WebUI.executeJavaScript('$(\'body > app-root > div > mat-sidenav-container > mat-sidenav-content > div > div > app-topic-types-list > div > app-floating-actions-buttons > eco-fab-speed-dial > div > eco-fab-speed-dial-actions > button > span > a > mat-icon\').trigger(\'click\')',
	[])
