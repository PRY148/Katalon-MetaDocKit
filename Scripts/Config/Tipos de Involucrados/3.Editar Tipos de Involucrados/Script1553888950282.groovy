...
WebUI.delay(5)
java.util.List<WebElement> listActions = WebUiCommonHelper.findWebElements((findTestObject('Config/Tipo contenido/btnEditInvolucrados')), 2)
...
WebElement btnActions = listActions.get(0)
WebUI.delay(5)
btnActions.click()

WebUI.setText(findTestObject('Object Repository/Config/Tipos de Involucrados/input_involved_type_name'), 'Edicion para Test Suit')
